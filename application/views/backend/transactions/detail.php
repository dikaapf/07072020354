<div class="invoice p-3 mb-3">
  ...
  <!-- info row -->
	...
	<div class="col-sm-4 invoice-col">
	  From
	 	<address>
	    <strong><?php echo $transaction->billing_first_name . " " . $transaction->billing_last_name; ?></strong><br>
		    <?php echo $transaction->billing_address_1?><br>
		    <?php echo $transaction->billing_address_2?><br>
	...
	<div class="col-sm-4 invoice-col">
	  To
	  	<address>
		    <strong><?php echo $transaction->shipping_first_name . " " . $transaction->shipping_last_name; ?></strong><br>
		    <?php echo $transaction->shipping_address_1?><br>
		    <?php echo $transaction->shipping_address_2?><br>
            ...
            <table class="table">
              ...
              <tr>
                ...
                <td>
                	...
                	echo  (($transaction->sub_total_amount - $transaction->coupon_discount_amount) + ($transaction->tax_amount + $transaction->shipping_method_amount + ($transaction->shipping_method_amount * $transaction->shipping_tax_percent)) );  
